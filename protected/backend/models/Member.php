   ...
   // public $countphotos;
	...
	public function rules()
	{
		...
		return array(
			...
			array('password, type, password_repeat, role, aktivation_key, email', 'required', 'on'=>'register'),
	...
	public function relations()
	{
		...
		return array(
			...
			'photos' => array(self::HAS_MANY, 'Mobilepictures', 'companyID'),
			'countphotos' => array(self::STAT, 'Mobilepictures', 'companyID','select' => 'COUNT(image)'),
		);
	}
