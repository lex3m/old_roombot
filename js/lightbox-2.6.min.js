(function () {
    ...
    d = (function () {
        ...
        c.prototype.build = function () {
            var c = this;
            b("<div id='lightboxOverlay' class='lightboxOverlay'></div><div id='lightbox' class='lightbox'><div class='lb-outerContainer'><div class='lb-container'><img class='lb-image' src='' /><div class='lb-nav'><a class='lb-prev' href='' ></a><a class='lb-next' href='' ></a></div><div class='lb-loader'><a class='lb-cancel'></a></div></div></div><div class='lb-dataContainer'><div class='lb-data'><div class='lb-details'><span class='lb-caption'></span><span class='lb-number'></span></div><div class='lb-closeContainer'><img class='checkImage' style='float: left; padding-right: 35px; cursor: pointer;' width='24px' height='24px' src='/images/site/uncheckepicture.png'><a class='lb-close'></a></div></div></div></div>").appendTo(b('body'));
        ...
        c.prototype.start = function (c) {
            ...
            this.$lightbox = b('#lightbox');
            this.$checker = this.$lightbox.find('.checkImage');
            this.$checker.attr('id', id);
            //--- end fix ---//
