...
if (isset($attribs['name']) && $attribs['name'] == 'user3') {
    ...
    echo '</ul>';
} else if (0 === strpos($params->get('moduleclass_sfx'), 'gaz-vmenu') || false !== strpos($params->get('moduleclass_sfx'), ' gaz-vmenu')) {
    $menutype = 'vertical';
