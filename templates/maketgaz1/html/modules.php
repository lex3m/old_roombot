...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'gaz-nostyle';
  $styles = array(
    'gaz-nostyle' => 'modChrome_artnostyle',
    'gaz-block' => 'modChrome_artblock',
    'gaz-article' => 'modChrome_artarticle',
    'gaz-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'gaz-...'        - overwrites the default module style.
  //  'suffix gaz-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add gaz-... to the module elements.
...
<!-- begin nostyle -->
<div class="gaz-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
