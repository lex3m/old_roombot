...
if (isset($attribs['name']) && $attribs['name'] == 'user3') {
    ...
    echo '</ul>';
} else if (0 === strpos($params->get('moduleclass_sfx'), 'gazvmenu') || false !== strpos($params->get('moduleclass_sfx'), ' gazvmenu')) {
    $menutype = 'vertical';
