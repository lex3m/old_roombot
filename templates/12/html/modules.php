...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'gaznostyle';
  $styles = array(
    'gaznostyle' => 'modChrome_artnostyle',
    'gazblock' => 'modChrome_artblock',
    'gazarticle' => 'modChrome_artarticle',
    'gazvmenu' => 'modChrome_artvmenu'
  );
...
<!-- begin nostyle -->
<div class="gaznostyle<?php echo $params->get('moduleclass_sfx'); ?>">
