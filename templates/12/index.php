...
<div class="gaztextblock gazobject21079369" data-left="100%">
        <div class="gazobject21079369-text">ТОВ "Галузеве підприємство "Промсервіс"<br>Адрес: 40030, Україна, м. Суми, вул. О. Береста, 13<br>тел.: +38-050-407-27-79<br>&nbsp; &nbsp; &nbsp; &nbsp; +38-0542-77-17-47</div>
    
</div><div class="gaztextblock gazobject2134721586" data-left="35.61%">
        <div class="gazobject2134721586-text"><span style="color: rgb(255, 255, 255); font-family: Arial, 'Arial Unicode MS', Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 24px; white-space: nowrap; "><a href="#" contenteditable="true" id="headline" style="line-height: 28px; text-decoration: none; color: rgb(255, 255, 255); outline-color: rgb(100, 100, 100); ">Постачання природного газу<br>за нерегульованим тарифом</a></span></div>
...
<footer class="gazfooter clearfix"><?php echo $view->position('copyright', 'gaznostyle'); ?></footer>
    ...
    <p class="gazpage-footer">
        <span id="gazfootnote-links">Разработка сайта <a href="http://topsu.ru/" target="_blank">topsu.ru</a>.</span>
    </p>
</div>
